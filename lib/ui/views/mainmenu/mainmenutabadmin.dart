...
import 'package:deepaprakasar/ui/views/adminoperations.dart';
...
class MainMenuTabAdmin extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => MainMenuTabAdminState();
}

class MainMenuTabAdminState extends State<MainMenuTabAdmin>
          ...
          bottom: TabBar(
            ...
            tabs: [
              ...
              Tab(
                  ...
                  child: Text(Strings.TITLE_MM_TB_ADMOPR)),
            ],
          ),
          title: Center(
            child: Column(
