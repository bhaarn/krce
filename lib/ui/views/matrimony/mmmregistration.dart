import 'package:deepaprakasar/database/crud/user/registermmm.dart';
...
class MMMRegistration extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => MMMRegistrationState();
}

class MMMRegistrationState extends State<MMMRegistration> {
            ...
            if (firstNameFieldController.text.isNotEmpty &&
              ...
              setState(() {
                _futureStatus = registerMmm(
                    ...
                    listPreferenceText[tabTextIconPreferenceIndexSelected]);
              });
            } else {
...
//                  mainAxisAlignment: MainAxisAlignment.spaceAround,
                      children: <Widget>[
                                  ...
                                  setState(() {
                                    DatePicker.showTime12hPicker(
                                      ...
                                      onConfirm: (date) {
                                        ...
                                        dbTime =
                                            DateFormat(Strings.DET_MMM_REG_TIME_FMT_DB).format(date);
                        ...
                        DropdownButtonFormField<Padham>(
                          decoration:
                              inputDecoration(Strings.DD_HINT_SEL_PADHAM),
